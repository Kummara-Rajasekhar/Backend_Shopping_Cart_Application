...
import com.rajasekhar.dreamshops.service.category.ICategoryService;
...
public class CategoryController {
  ...
  @PutMapping("/category/{id}/update")
    public ResponseEntity<ApiResponse> updateCategory(@PathVariable Long id,@RequestParam Category category){
        try{
